               ...
               vector<string>            &surfaceNames)
{
    ...
    while (in >> objType) 
    {
        ...
        if (objType == "bez2")
        {
            ...
            curves.push_back( evalBezier(cpsToAdd = readCps(in, 2), steps, 2) );
        ...
        else if (objType == "bsp2")
        {
            ...
            in >> steps;
            curves.push_back( evalBspline(cpsToAdd = readCps(in, 2), steps, 2) );
            curveNames.push_back(objName);
            dims.push_back(2);
            if (named) curveIndex[objName] = dims.size()-1;
        }
        else if (objType == "bez3")
        {
            ...
            in >> steps;
            curves.push_back( evalBezier(cpsToAdd = readCps(in, 3), steps, 3) );
            curveNames.push_back(objName);
            dims.push_back(3);
            if (named) curveIndex[objName] = dims.size()-1;
        ...
        else if (objType == "bsp3")
        {
            ...
            in >> steps;
            curves.push_back( evalBspline(cpsToAdd = readCps(in, 3), steps, 3) );
            curveNames.push_back(objName);
            dims.push_back(3);
            if (named) curveIndex[objName] = dims.size()-1;
        }

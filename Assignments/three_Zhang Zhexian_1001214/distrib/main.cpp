...
namespace
{
  ...
  void initSystem(int argc, char * argv[])
  {
	...
	if(argc<4){
      cout<<"Run application in this format: a3 s|p|c e|t|r stepSize numParticle|gridSize"<<endl;
	  cout<<"Example 1: a3 s r 0.05"<<endl;
	  cout<<"Example 2: a3 p r 0.05 1"<<endl;
	  cout<<"Example 3: a3 c r 0.005 8"<<endl;
      exit(0);
    }
    if(*argv[1]=='s'){
	  //renderCloth=false;
      ...
      //parse the number of particles we want
      int gridSize = atoi(argv[4]);
      system = new ClothSystem(gridSize);
    }

	else{
      cout<<"Run application in this format: a3 s|p|c e|t|r stepSize numParticle|gridSize"<<endl;
	  cout<<"1st argument needs to be either 's' (Particle System), 'p' (Pendulum System), or 'c' (Cloth System)"<<endl;
      exit(0);
    }


	///TODO: Optional. modify this function to switch between different timeSteppers
	if(*argv[2]=='e'){
      ...
      cout<<"Run application in this format: a3 s|p|c e|t|r stepSize numParticle|gridSize"<<endl;
	  cout<<"2nd argument needs to be either 'e' (ForwardEuler), 't' (Trapezoidal), or 'r' (RK4)"<<endl;
	  exit(0);
    }
...
int main( int argc, char* argv[] )
{
    ...
    glutCreateWindow("Assignment 3_Zhang Zhexian_1001214");
